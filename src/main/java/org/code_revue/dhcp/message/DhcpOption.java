...
public enum DhcpOption {
    ...
    private static final Comparator<Object> comp = new Comparator<Object>() {
        ...
        public int compare(Object o1, Object o2) {
            return ((DhcpOption) o1).getNumericCode() - ((int) o2);
        }
    };

    private DhcpOption(int numericCode) {
     ...
     * @return
     */
    public static DhcpOption getByNumericCode(int code) {
        int index = Arrays.binarySearch(DhcpOption.values(), code, comp);
        if (index < 0) {
            throw new IllegalArgumentException("Invalid numeric code.");
        }
        return DhcpOption.values()[index];
    }
